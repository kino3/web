...
sub edit {
    ...
    if ($mode eq "vup") {
        ...
        while (<IN>){
            ...
            if ($tmp =~ /^my/) {
                ...
                } elsif ($tmp =~ /\$comment_filter_str[^"']*["']([^"']*)["']/) {
                    $cfg{'CommentFilterStr'} = enc_tag($1);
    ...
    if ( !exists $cfg{'CatSelect'} ) { $cfg{'CatSelect'} = 1; }
    ...
    print '        <li><a href="#Dscrptn">トップ（記事一覧）への概要の表示</a></li>';
    print '        <li><a href="#DispNum">トップ（記事一覧）に表示させる記事数</a></li>';
    print '        <li><a href="#DT">トップ（記事一覧）での投稿日時の表示</a></li>';
    print '        <li><a href="#Colors">色の設定</a></li>';
    print '        <li><a href="#IndividualAuthorDisp">個別記事画面での投稿者名表示</a></li>';
    print '    </ul>';
    print '    </li>';
    print '</ul>';
    print '<ul>';
    ...
    print '    <li>カテゴリ関連設定項目';
    print '    <ul>';
    print '        <li><a href="#IndividualCatLabelDisp">個別記事画面でのカテゴリ名表示</a></li>';
    print '        <li><a href="#CatSelect">カテゴリセレクタの表示／非表示</a></li>';
    ...
    print '        <li><a href="#ExitChtmlTrans">chtmltrans変換の無効化</a></li>';
    print '        <li><a href="#MobileGW">外部リンク先のモバイル変換ゲートウェイ選択</a></li>';
    ...
    print '        <li><a href="#AdminDoor">管理者用バックドアの表示</a></li>';
    ...
    print '</div>';
    print '<div class="description">';
    print '携帯対応リンクの前に表示する文字(付けたくない場合は空文字列にする）';
    print '</div>';
    print '<div class="input">';
    ...
    print '<h4 id="MobileGW">MobileGW - 外部リンク先のモバイル変換ゲートウェイ選択</h4>';
    print '<div class="input">';
    ...
    print '<h4 id="IndividualAuthorDisp">IndividualAuthorDisp - 個別記事画面での投稿者名表示</h4>';
    print '<div class="description">';
    print 'タイトル横への投稿者名（ログイン名）表示。<br />';
    print '表示名（ニックネーム）が入力されていれば、そちらを表示する。<br />';
    print '投稿者が複数いる場合などに。<br />';
    print '</div>';
    print '<div class="input">';
    ...
    print '<h4 id="CatSelect">CatSelect - カテゴリセレクタの表示／非表示</h4>';
    print '<div class="description">';
    print 'カテゴリセレクタなんぞ必要ないという方はこれをOFFに。';
    print '</div>';
    print '<div class="input">';
    print '<select name="CatSelect">';
    if ($cfg{CatSelect} eq '1') {
        print '<option value="1" selected>表示（デフォルト）</option>';
        print '<option value="0">非表示</option>';
    } else {
        print '<option value="1">表示（デフォルト）</option>';
        print '<option value="0" selected>非表示</option>';
    }
    print '</select>';
    print '</div>';
    print '<div class="backlink"><a href="#top">ページのTOPへ戻る</a></div>';
